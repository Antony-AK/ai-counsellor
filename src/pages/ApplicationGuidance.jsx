...
export default function ApplicationGuidance() {
  ...
  // 🚀 SINGLE SOURCE OF TRUTH (DB → AI → UI)
  const loadUniversityTasksAuto = async (uni, userProfile) => {
    ...
    // 2️⃣ PREVENT DUPLICATE AI CALLS
        ...
        <div className="md:col-span-2 space-y-6 md:space-y-8">
          ...
          {loading && (
            <p className="text-center text-gray-500">
              AI is preparing your application plan and tasks…
            </p>
          )}
              ...
              >
                {groupTasks.map(task => (
                  <Task
                    key={task.id}
                    {...task}
                    universityName={selectedUni?.name}   // ✅ PASS IT HERE
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-[0_6px_18px_rgba(0,0,0,0.06)]  p-4 md:p-6">
            <ul className="space-y-3 text-sm text-gray-700">
              <li className="flex items-center gap-2">📄 Statement of Purpose (SOP)</li>
              <li className="flex items-center gap-2">📄 Letters of Recommendation</li>
              <li className="flex items-center gap-2">📄 Academic Transcripts</li>
              <li className="flex items-center gap-2">📄 Resume / CV</li>
              <li className="flex items-center gap-2">📄 English Proficiency Score</li>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          ...
          <div className="bg-white w-[95%] md:max-w-lg max-h-[90vh] overflow-y-auto rounded-3xl p-5 md:p-8 shadow-2xl text-center relative">
            ...
            <p className="text-gray-600 mb-6">
              You’ve successfully completed all application tasks for
            </p>
            ...
            <div className="bg-gray-50 rounded-xl p-4  text-sm text-gray-700 mb-6">
              <p className="mb-2"><strong>Degree:</strong> {profile?.intendedDegree || "—"}</p>
              <p className="mb-2"><strong>Field:</strong> {profile?.fieldOfStudy || "—"}</p>
              <p className="mb-2"><strong>Target Intake:</strong> {profile?.targetIntake || "—"}</p>
            </div>

            {/* MOTIVATION */}
            <p className="text-gray-600 mb-6">
              You’re fully prepared to apply.
              Best of luck with your application - go crush it 🚀
            </p>
